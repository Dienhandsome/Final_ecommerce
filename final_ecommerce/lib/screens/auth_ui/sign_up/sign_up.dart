...
class _LoginState extends State<SignUp> {
  ...
  Widget build(BuildContext context) {
    return   Scaffold(
     resizeToAvoidBottomInset: false, // giúp xử lí màn hình không thay đổi kích thước và giao diện không hiện lên án màn
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [                                                          
              TopTitles(subtitle: "Welcome Back To Ecommerce App ", title: "SignUp"),
